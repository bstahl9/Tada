...
export const SelectSequenceModal = ({ visible, onClose, track }: SelectSequenceModalProps) => {
  const [selectedSequence, setSelectedSequence] = useState("");
  const { sequences, addTrackToSequence, fetchTracksForSequence } = useLibraryStore();
  ...
  const handleAddToSequence = async () => {
    ...
    try {
      await addTrackToSequence(track, sequenceToAdd.id);
      fetchTracksForSequence(sequenceToAdd.id);
